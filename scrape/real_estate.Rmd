...
This is checking to make sure you are allowed to scrape the data. TRUE = ok
...
Example: get just the house price; if you put in the node after html_nodes it pull out all the data and adding html_text will remove all of the crap so that you only see the data inside the node.
```{r}
